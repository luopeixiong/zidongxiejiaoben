...
logging.basicConfig(
    filename='/www/wwwroot/bcy/jiancha_jobs3.log',
...
class ScrapydJobs:
    def __init__(self):
        ...
        self.heimingdan_txt = open('/www/wwwroot/bcy/job3_heimingdan.txt', 'a', encoding='utf-8')
