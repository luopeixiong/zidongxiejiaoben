...
logging.basicConfig(
    filename='/www/wwwroot/bcy/qidongdeng_gongju/jiequ_rizi_baocuo/jiancha_logszyl.log',
...
class Jobs:
    def __init__(self):
        ...
        self.baocuo_big_dic = {}
        with open('/www/wwwroot/bcy/qidongdeng_gongju/jiequ_rizi_baocuo/jiancha_logs_zhubaocuozyl.txt', 'r', encoding='utf-8') as f:
    ...
    def start2(self):
        ...
        with open('/www/wwwroot/bcy/qidongdeng_gongju/jiequ_rizi_baocuo/jiancha_logszyl.json', 'w', encoding='utf-8') as f:
