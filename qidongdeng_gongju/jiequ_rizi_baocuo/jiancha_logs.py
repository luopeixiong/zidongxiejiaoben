...
logging.basicConfig(
    filename='/www/wwwroot/bcy/qidongdeng_gongju/jiequ_rizi_baocuo/jiancha_logs.log',
...
class Jobs:
    def __init__(self):
        ...
        self.baocuo_big_dic = {}
        with open('/www/wwwroot/bcy/qidongdeng_gongju/jiequ_rizi_baocuo/jiancha_logs_zhubaocuo.txt', 'r', encoding='utf-8') as f:
